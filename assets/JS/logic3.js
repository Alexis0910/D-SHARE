...
var idToLoc = function(route) {
  startX = places[route3[0]].locX;
  startY = places[route3[0]].locY;

  endX = places[route3[1]].locX;
  endY = places[route3[1]].locY;

  if (route[2]) {
    wayX = places[route3[2]].locX;
    wayY = places[route3[2]].locY;
  }
};
